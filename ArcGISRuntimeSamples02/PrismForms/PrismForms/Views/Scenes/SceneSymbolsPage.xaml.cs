...
namespace PrismForms.Views
{
	public partial class SceneSymbolsPage : ContentPage
	{
		...
		private void addGraphics()
		{
			...
			//Graphic[] graphics = new Graphic[6];
			var i = 0;
		...
		private Colors randColor()
		{
			return Colors.FromArgb(randFloat(), randFloat(), randFloat());
   		}	

		 //returns a CGFloat between 0 and 1
		private Int32 randFloat()
		{
			Random rand = new Random();
			//int randInt = (rand.Next() % 256) / 256;
			int randInt = (rand.Next() % 256);
